...
export const GOOGLE_PIXEL_CHROME: NavigatorLike = {
  userAgent:
    'Mozilla/5.0 (Linux; Android 16; Pixel 9 Build/CP1A.260505.005; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/150.0.7871.124 Mobile Safari/537.36',
  platform: '',
  maxTouchPoints: 5,
};
